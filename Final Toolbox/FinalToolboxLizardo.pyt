...
class ListRasters(object):
    ...
    def getParameterInfo(self):
        ...
        input_raster = arcpy.Parameter(name="input_raster", # Variable name
                                     displayName="Folder:", # Text that will be displayed in GUI
                                     datatype="DEFolder", # Type of data that can be inputted or outputted
                                     parameterType="Required", # Required or Optional or Derived
                                     direction="Input") # Input or output
        parameters.append(input_raster)
        file = arcpy.Parameter(name="file_type", # Variable name
                                    displayName="Raster file extension:", # Text that will be displayed in GUI
                                    datatype="GPString",  # Type of data that can be inputted or outputted
                                    parameterType="Required",  # Required or Optional or Derived
                                    direction="Input") # Input or output
